...
/** The user-facing display label of an MCP server (from tysh settings). */
 ...
 * to tysh MCP server display labels.
 */
 ...
 * @param mcpServerMappings Maps friendly server names (from agent files) → tysh MCP display labels.
