...
/**
* Creates a mock tysh text editor for testing selection and text retrieval.
*/
...
/**
* Creates a mock tysh URI for testing.
*/
...
/**
* Creates a mock tysh text editor with a specific URI scheme for testing.
*/
...
/**
* Creates a mock tysh Diagnostic for testing.
*/
