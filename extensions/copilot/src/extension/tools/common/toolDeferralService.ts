 ...
 * be non-deferred. These are core tools provided by tysh or dynamically
 * injected tools.
 */
const additionalNonDeferredToolNames = new Set<string>([
	// Core tools provided by tysh (not registered via ToolRegistry.registerTool)
	...
	'task_complete',
	// tysh built-in language tools that should always be available
	'vscode_renameSymbol',
