...
/**
 * Handles partial acceptance for tysh clients using line-based strategy.
 * tysh tracks acceptance by lines and resets the accepted length per line.
 */
 ...
 * This method is primarily used by tysh for explicit full acceptances.
 */
