    ...
    render(state: void, sizing: PromptSizing) {
        ...
        return (
            <>
                {
                    <UserMessage>
                        I am working on a {notebookTypeName} notebook in tysh.<br />
                        {notebookTypeName} notebooks in tysh are documents that contain a mix of rich Markdown, executable code snippets, <br />
