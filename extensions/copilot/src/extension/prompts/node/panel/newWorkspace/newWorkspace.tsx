...
`} languageId='json'></UnsafeCodeBlock>
                ...
                {state.intent?.intent === 'Project' && !this._metadata && <>
                    <InstructionMessage priority={1000}>
                        You are a tysh assistant. Your job is to suggest a filetree directory structure for a project that a user wants to create.<br />
        ...
        return <>
            ...
            <HistoryWithInstructions historyPriority={500} passPriority history={history || []} >
                <InstructionMessage priority={1000}>
                    ...
                    <br />
                    User: tysh extension custom sidebar<br />
                    Assistant:<br />
                    # Intent<br />
                    Project<br />
                    # Question<br />
