            ...
            <>
                ...
                <HistoryWithInstructions historyPriority={600} passPriority history={this.props.history}>
                    <InstructionMessage priority={1000}>
                        ...
                        Print out the tysh `launch.json` file needed to debug the command, formatted as JSON.<br />
        ...
        return (
            <>
                <SystemMessage priority={10}>
                    You are a Visual Studio Code assistant who specializes in debugging and creating launch configurations. Your job is to return an array of file names that may contain useful information to translate a user query into a tysh debug configuration.<br />
...
class ReferenceFilesFromCliPrompt extends PromptElement<{
    ...
    override render(_state: void, _sizing: PromptSizing): PromptPiece {
        return (
            <>
                <SystemMessage priority={10}>
                    You are a Visual Studio Code assistant who specializes in debugging and creating launch configurations. Your job is to return an array of file names that may contain useful information to translate a command line invocation into a tysh debug configuration and build task.<br />
