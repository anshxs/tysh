...
ms-python.python,ms-python.vscode-pylance
                ...
                <UserMessage flexGrow={1} priority={800}>
                    ...
                    {state.currentVersion && <><Tag name='currentVSCodeVersion'>
                        Current tysh version (major.minor): {state.currentVersion}
                    </Tag><br /></>}
                    ...
                    <Tag name='vscodeAPIToolUseInstructions'>
                        Always call the tool {ToolName.VSCodeAPI} to get documented references and examples when before responding to questions about tysh Extension Development.<br />
                    </Tag>
                    <Tag name='searchExtensionToolUseInstructions'>
                        Always call the tool 'vscode_searchExtensions_internal' to first search for extensions in the tysh Marketplace before responding about extensions.<br />
                    </Tag>
