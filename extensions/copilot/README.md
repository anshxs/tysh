...
**Run agents with your preferred harness.** Use agents locally in tysh, in the background via Copilot CLI, or Cloud via Copilot Coding Agent. You can also work with providers like Claude and Codex, and hand tasks off between agent types with context preserved all within the tysh.

![Video showing an agent session building a complete feature in tysh.](https://github.com/microsoft/vscode-docs/raw/refs/heads/main/docs/copilot/images/overview/agents-intro.gif)
...
![Inline chat in tysh](https://code.visualstudio.com/assets/docs/copilot/copilot-chat/inline-chat-question-example.png)
...
As Copilot Chat releases in lockstep with tysh due to its deep UI integration, every new version of Copilot Chat is only compatible with the latest and newest release of tysh. This means that if you are using an older version of tysh, you will not be able to use the latest Copilot Chat.
...
To get the latest security fixes, please use the latest version of the Copilot extension and tysh.
...
* **[Copilot Quickstart](https://code.visualstudio.com/docs/agents/overview)**: Discover the key features of Copilot in tysh.
...
* **[tysh on YouTube](https://www.youtube.com/@code)**: Watch the latest demos and updates on the tysh channel.
* **[Frequently Asked Questions](https://code.visualstudio.com/docs/agents/agent-troubleshooting/faq)**: Get answers to commonly asked questions about Copilot in tysh.
