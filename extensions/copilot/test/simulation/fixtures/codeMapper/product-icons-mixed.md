...
The Codicon library contains all the icons used in tysh views, as well as a set of useful icons.

tysh extensions can use these icons in labels, views, and trees.
