 ...
 * like GIT_ASKPASS point to scripts inside the tysh installation directory, which
...
/**
 * Checks if the current tysh installation is a Windows user or system setup.
 ...
 * This prevents accumulation of old versions when tysh updates.
 */
