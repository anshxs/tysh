# tysh Release Sanity Check Tests

## Overview

Automated end-to-end release sanity tests for published tysh builds.
...
Many tests will use the underlying platform to install and verify basic tysh functionality.
...
- Architecture-specific tysh dependencies
...
The following public documentation pages provide details on end-user tysh setup scenarios.

- [Download tysh](https://code.visualstudio.com/Download)
...
- [tysh Server](https://code.visualstudio.com/docs/remote/vscode-server)
