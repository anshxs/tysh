...
The tysh Sweeper reviewed it, judged it **agent-ready**, and wrote a **brief** while
...
- `Fixes #<issue-number>`
- `Seeded by a tysh Sweeper review: https://github.com/egamma/vscodesweeper-state/blob/state/records/microsoft/vscode/items/<issue-number>.md`
