---
description: Architecture documentation for tysh notebook and interactive window components. Use when working in `src/vs/workbench/contrib/notebook/`
---

# Notebook Architecture

This document describes the internal architecture of tysh's notebook implementation.
