...
class ElementPicker {
	...
	private static readonly _CURSOR_DEFAULT = '/* tysh injected style */ * { cursor: default !important; }';
	private static readonly _CURSOR_CROSSHAIR = '/* tysh injected style */ * { cursor: crosshair !important; }';
