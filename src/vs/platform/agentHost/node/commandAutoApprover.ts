...
export interface IShouldAutoApproveOptions {
	...
	/**
	 * Effective tysh `chat.tools.terminal.autoApprove` rules forwarded from
 ...
 * The rules are normally forwarded from tysh's
...
// ---- Default rules ----------------------------------------------------------
//
// Compatibility fallback for clients that do not forward the tysh
