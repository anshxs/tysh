...
export async function buildOptions(
	...
	const settingsEnv: Record<string, string> = {
		...
		// Attribute the CLI's tool subprocesses (`gh`, …) to tysh.
		...
		// tool, so commands from that tool are not attributed to tysh.
 ...
 * proxied env still announces the originating tysh surface. Mirror of the
