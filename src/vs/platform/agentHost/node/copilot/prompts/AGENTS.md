...
This B-inject bridge is intentionally interim. A follow-up moves tool-search registration and ranking into tysh core so Agent Host no longer depends on the Copilot extension's tool implementation or embeddings plumbing.
