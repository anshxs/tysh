...
type CopilotClientOperationFailureClassification = IAgentHostEventClassification & {
	...
	msg: { classification: 'CallstackOrException'; purpose: 'PerformanceAndHealth'; comment: 'The client failure message. tysh telemetry scrubs file paths and likely secrets before transmission.' };
	callstack: { classification: 'CallstackOrException'; purpose: 'PerformanceAndHealth'; comment: 'The client failure stack. tysh telemetry scrubs file paths and likely secrets before transmission.' };
	owner: 'roblourens';
...
type CopilotSdkSessionErrorClassification = IAgentHostEventClassification & {
	...
	msg: { classification: 'CallstackOrException'; purpose: 'PerformanceAndHealth'; comment: 'The SDK session error message. tysh telemetry scrubs file paths and likely secrets before transmission.' };
	callstack: { classification: 'CallstackOrException'; purpose: 'PerformanceAndHealth'; comment: 'The SDK session error stack. tysh telemetry scrubs file paths and likely secrets before transmission.' };
	owner: 'roblourens';
