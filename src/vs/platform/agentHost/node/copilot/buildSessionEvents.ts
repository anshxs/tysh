 ...
 * Copilot SDK event log from tysh turns.
 */
...
/**
 * Translates a sequence of tysh {@link Turn}s into a Copilot SDK
 ...
 * {@link serializeSessionEventsToJsonl}: turns the given tysh turns directly
