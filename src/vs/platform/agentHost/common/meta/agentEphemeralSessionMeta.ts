...
/** tysh-owned request metadata indicating a throwaway chat surface. */
...
/** Typed view over tysh's ephemeral-session request metadata. */
...
/** Adds tysh's ephemeral-session metadata to an open request metadata bag. */
