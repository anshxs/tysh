...
/** The metadata key for tysh-owned chat-surface information. */
...
/** tysh-owned metadata describing the chat surface that created a session. */
...
/** Adds tysh's typed chat-surface metadata to an open request metadata bag. */
