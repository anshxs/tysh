 ...
 * by the tysh CLI, asks the CLI to check for a server upgrade and
 ...
 * data payload. Servers that are spawned by the tysh CLI populate this
 ...
 * extension used by tysh-hosted agent hosts.
 *
