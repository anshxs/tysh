...
type AgentHostProcessErrorClassification = {
	hostLaunchKind: { classification: 'SystemMetaData'; purpose: 'PerformanceAndHealth'; comment: 'Whether the agent host process was launched by the tysh main process or tysh CLI.' };
	...
	willRestart: { classification: 'SystemMetaData'; purpose: 'PerformanceAndHealth'; isMeasurement: true; comment: 'Whether tysh will attempt to restart the agent host after this failure.' };
