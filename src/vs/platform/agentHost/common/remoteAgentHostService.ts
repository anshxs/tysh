...
export type RemoteAgentHostConnectionStatus =
	...
	| {
		 ...
		 * Set only when the server was spawned by a tysh CLI willing
...
export interface IRemoteAgentHostSSHConnection {
	 ...
	 * client connects to, and is used to construct the tysh Remote
...
export interface IRemoteAgentHostTunnelConnection {
	 ...
	 * Used as the tunnel name in the tysh Remote Tunnels authority
...
export interface IRemoteAgentHostDevContainerConnection {
	...
	/** tysh SSH, tunnel, or WSL authority of the source host, absent for local containers. */
