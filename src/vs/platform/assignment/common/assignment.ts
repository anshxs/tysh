...
export enum Filters {
	...
	/**
	 * The platform (OS) on which tysh is running.
	 */
	Platform = 'X-VSCode-Platform',

	/**
	 * The release/build date of tysh (UTC) in the format yyyymmddHH.
	 */
	ReleaseDate = 'X-VSCode-ReleaseDate',

	/**
	 * The kind of window tysh is running in (`editor` or `agents`).
	 */
...
/**
 * Emits the generic tysh core filters for the new TAS assignments API using the new
