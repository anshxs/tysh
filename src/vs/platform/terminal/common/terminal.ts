...
export interface IShellLaunchConfig {
	...
	/**
	 * Whether the terminal process environment will inherit tysh's "shell environment" that may
	 ...
	 * a terminal used to drive some tysh feature.
	 */
	isFeatureTerminal?: boolean;
	...
	tabActions?: ITerminalTabAction[];
	/**
	 * Report terminal's shell environment variables to tysh and extensions
	 */
...
export const enum ShellIntegrationStatus {
	...
	FinalTerm,
	/** tysh shell integration sequences have been encountered. Supercedes FinalTerm. */
	VSCode
}
