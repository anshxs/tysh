	...
	if (state === 'skipped') {
		...
		model = {
			...
			activity: [{
				...
				items: [
					{ label: 'prepare-release', sourceLabel: 'tysh profile/prepare-release.prompt.md', targetLabel: '~/.agents/skills/prepare-release/SKILL.md', operation: 'converted' },
					{ label: 'release-manager', sourceLabel: 'tysh profile/release-manager.agent.md', targetLabel: '~/.agents/agents/release-manager.agent.md', operation: 'moved' },
					{ label: 'typescript-style', sourceLabel: 'tysh profile/typescript-style.instructions.md', targetLabel: '~/.agents/instructions/typescript-style.instructions.md', operation: 'copied' },
				],
			}],
		};
	}
