...
const markdownLinksQuestion: IChatQuestion = {
	...
	message: new MarkdownString('**Review the [tysh documentation](https://code.visualstudio.com/docs) before continuing.**'),
	detailedMessage: new MarkdownString([
		...
		'',
		'- **[tysh repository](https://github.com/microsoft/vscode)**',
