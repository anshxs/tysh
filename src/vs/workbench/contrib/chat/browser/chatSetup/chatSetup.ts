...
/**
 * Builds a redirect URL that GitHub will use to return the user to tysh
 ...
 * @param urlProtocol The tysh URL protocol scheme (e.g. `vscode`, `vscode-insiders`, `codetysh`).
