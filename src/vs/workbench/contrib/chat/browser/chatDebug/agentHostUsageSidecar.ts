 ...
 * token-usage sidecar files. Kept separate from tysh's other user-data
 ...
 * token metrics survive a tysh restart (the reduced chat state keeps only the
 ...
 * stable, client-local per-session sidecar so token metrics survive a tysh
