...
const DISPLAY_NAME = 'tysh Synced Data';
...
const MANIFEST_CONTENT = JSON.stringify({
	name: DISPLAY_NAME,
	description: 'Customization data synced from tysh',
}, null, '\t');
...
/**
 * An MCP server configured directly in tysh (i.e. not contributed by an
 ...
 * ```
 * .plugin/plugin.json
 * .mcp.json        ← MCP servers configured in tysh
