...
export interface IModelPickerUnavailableEntry {
	...
	/** The model exists for this account but needs a newer tysh. */
...
export interface IModelPickerSectionsOptions {
	...
	/** This build's version, used to spot models gated behind a newer tysh. */
...
/** Whether the entry names a minimum tysh version this build does not meet. */
