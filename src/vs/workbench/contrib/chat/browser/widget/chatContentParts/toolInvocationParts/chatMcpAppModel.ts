...
export class ChatMcpAppModel extends Disposable {
	 ...
	 * tysh restarts — using {@link WebviewOriginStore} for them would
		...
		try {
			...
			switch (request.method) {
				...
				case 'ui/request-display-mode':
					// tysh only supports inline display mode
	 ...
	 * server-definition id is stable across tysh restarts. Agent-host
