...
export const chatWorkingProgressStableIconForeground = registerColor(
	...
	localize('chat.workingProgressStableIconForeground', 'Foreground color of the Stable tysh icon in the chat working progress indicator.'));
...
export const chatWorkingProgressInsidersIconForeground = registerColor(
	...
	localize('chat.workingProgressInsidersIconForeground', 'Foreground color of the Insiders tysh icon in the chat working progress indicator.'));
