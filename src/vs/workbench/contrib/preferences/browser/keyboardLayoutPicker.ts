...
const DEFAULT_CONTENT: string = [
	`// ${nls.localize('displayLanguage', 'Defines the keyboard layout used in tysh in the browser environment.')}`,
	`// ${nls.localize('doc', 'Open tysh and run "Developer: Inspect Key Mappings (JSON)" from Command Palette.')}`,
	``,
