...
/**
 * Allows webviews to monitor when an element in the tysh editor is being dragged/dropped.
 *
 * This is required since webview end up eating the drag event. tysh needs to see this
