...
export interface ISessionsRecentWorkspacesService {
	...
	/** Whether tysh's recent-folder and workspace-file history has loaded; Agents-owned history is synchronous. */
	 ...
	 * considering tysh's recently opened folders.
	 */
	...
	/** Removes `folderUri` from the recent list, wherever it came from (own history or tysh's recents). */
