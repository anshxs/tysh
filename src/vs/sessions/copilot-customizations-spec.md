...
> **Specification change gate:** This is a scoped external-runtime snapshot, not a change log. Update it only after deliberately re-auditing the referenced runtime contract; do not patch it for tysh implementation bugs.
