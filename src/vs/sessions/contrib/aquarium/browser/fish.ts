...
/**
 * tysh logo "fish" used by the Agents window aquarium. Each fish is a small
...
/** The three tysh release channel colors used as fish "species". */
 ...
 * a single `<symbol>` containing the tysh logo path. All fish reference
 ...
 *   - tysh logo body, sliced into N vertical strips that each oscillate in
...
function buildFishSvg(targetDocument: Document): SVGSVGElement {
	...
	// viewBox 0..96 matches the original tysh icon.
