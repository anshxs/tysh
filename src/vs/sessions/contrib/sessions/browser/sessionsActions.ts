...
// Mirrors tysh's "Focus Editor Group N": Ctrl/Cmd+1..8 focus that grid slot
	...
	constructor() {
		super({
			...
			keybinding: {
				...
				// nothing was closed); inside it, tysh's own Reopen Closed
				// Editor takes over.
